...
class TestDongaParser(unittest.TestCase):
    ...
    def test_parsenewsurl(self, mock_urlReader):
        ...
        self.assertEqual(news['imageURL'], 'http://dimg.donga.com/wps/NEWS/IMAGE/2016/09/18/80317103.1.jpg')
...
'''))
    ...
    def test_parsenewslist(self, mock_urlReader):
        ...
        self.assertEqual(newslist[0]['title'], "‘우리 갑순이’ 김소은, 짠내 제로 청량감 가득 머금은 미소 포착")
        self.assertEqual(newslist[0]['url'], "http://news.donga.com/List/3/all/20160919/80336683/2")
        self.assertEqual(newslist[0]['providerNewsID'], "20160919/80336683/2")
        self.assertEqual(newslist[-1]['title'], "北 “함북도 수해지역 고무산청년~무산역 구간 철도 복구 개통”")
        self.assertEqual(newslist[-1]['url'], "http://news.donga.com/List/3/all/20160919/80336056/1")
