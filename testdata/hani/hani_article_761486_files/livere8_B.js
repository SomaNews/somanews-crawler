...
LivereContents = function() {
    this.init = function(obj) {
        ...
        if( obj && obj.box_status !== 0) {
            ...
            livereContents.contentsFactory(gdn, obj, linkType, parentDiv, cssData, isIos);
        }
    ...
    this.bindSetAtypeHeightEvent = function() {
        var eventMethod = window.addEventListener ? 'addEventListener' : 'attachEvent',
            setContentsHeight = window[eventMethod],
            lvContentsEvent = eventMethod == 'attachEvent' ? 'onmessage' : 'message';

        setContentsHeight(lvContentsEvent, function (e) {
