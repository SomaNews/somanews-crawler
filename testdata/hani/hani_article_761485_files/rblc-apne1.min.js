...
/* build at 2016-08-11 */
window._rblconf=window._rblconf||{};var rblinfo;!function(a){function b(){return window&&window.navigator&&window.navigator.userAgent?window.navigator.userAgent:""}function c(){var a=rblutil.getCookie("RB_PCID")||"";if(!a){var b=Math.floor(1e5+9e5*Math.random());a=(new Date).getTime()+String(b);var c=94608e6;rblutil.setCookieTop("RB_PCID",a,c)}return a}function d(){var a=rblutil.getParameter(window.location.search,"rccode");return a=a||rblutil.getParameter(window.location.search,"_reco"),a=a||""}function e(){var a,b=rblutil.getParameter(window.location.search,"adcode"),c=rblutil.getParameter(window.location.search,"adcode_timeout");b&&(a=c?Number(c):2592e5,rblutil.updateCookieTop("RB_ADCODE",String(b),a));var d=rblutil.getCookie("RB_ADCODE")||"";return d}function f(){var a=rblutil.getCookie("RB_ABGROUP")||rblutil.getCookie("RBABGRP");return a}function g(){var a=rblutil.getCookie("RB_SSID")||"";return a||(a=rblutil.createRandomAlpnum(10)),rblutil.updateCookieTop("RB_SSID",a,18e5),a}function h(){return rblutil.getParameter(window.location.search,"rbst")||""}function i(){var a="",b=rblutil.getString(rblutil.getReferrer(),void 0);return b&&(b=b.replace(/\+/g,"%20"),b.indexOf("naver")>-1?a=rblutil.getParameter(b,"query"):b.indexOf("daum")>-1&&(a=rblutil.getParameter(b,"q"))),a}function j(){var a="",b=rblutil.getString(rblutil.getReferrer(),void 0);return b&&(b.indexOf("naver")>-1?a="naver":b.indexOf("daum")>-1&&(a="daum")),a}function k(){var a="";try{a=LOOKETAPPS.rbGetAdId()}catch(b){}a||(a=rblutil.getCookie("looketappsadid"));try{a=window.caulyJSInterface.getAdId()}catch(b){}return a}function l(){var a="",b="";if(k())try{var b=rblutil.trim(window.caulyJSInterface.platform());a="Android"===b?"aaid":"iOS"===b?"idfa":"UNK"}catch(c){}return a}function m(){var a="";try{a=LOOKETAPPS.rbGetPushId()}catch(b){}return a||(a=rblutil.getCookie("looketappspushid")),a}function n(){var a="",b=rblutil.getCookie("looketapps");return b&&(a="ios"===b?"MI":"android"===b?"MA":"UNK"),a}function o(){var a="";try{if("undefined"!=typeof CaulyTracker){var b=new CaulyTracker;a=b.getStoredCID()}}catch(c){}if(!a||0===a.length)try{a=rblutil.isLocalStorageSupported()?rblutil.getStorageItem("CT_CID"):rblutil.getCookie("CT_CID")}catch(d){a=rblutil.getCookie("CT_CID")}return a}function p(){var a=rblutil.getCookie("wa_pcid")||"";return a}function q(){w=!1}function r(a){var b=94608e6;rblutil.setCookieTop("RB_GUID",a,b)}function s(b){w=!0,rblutil.JSONP({url:a.issuer,data:{},success:function(a){var c=a.RB_GUID;c&&r(c),"function"==typeof b&&b(c),q()},error:function(a){q()}})}function t(a){var b=rblutil.getCookie("RB_GUID");return b||w?b&&"function"==typeof a&&a(b):s(a),b}function u(a){var b=a||"";if(b){var c=(rblutil.getCookie("RB_VIEWED_ITEMS")||"").replace(/"/g,""),d=c.split(",");""===d[0]&&1==d.length&&(d=[]),d.length>9&&(d=d.slice(0,4)),d.unshift(b),rblutil.setCookieTop("RB_VIEWED_ITEMS",d.join(","),31536e6)}}function v(a){var b=a||"";if(b)try{var c=(rblutil.getStorageItem("RB_VIEWED_ITEMS")||"").replace(/"/g,""),d=c.split(",");""===d[0]&&1==d.length&&(d=[]),d.length>9&&(d=d.slice(0,9)),d.unshift(b),rblutil.setStorageItem("RB_VIEWED_ITEMS",d.join(","))}catch(e){}}a.issuer=("https:"===document.location.protocol?"https":"http")+"://rblogger-issuer-apne1.recobell.io/user/guid","string"==typeof window._rblconf.issuer&&(a.issuer=("https:"===document.location.protocol?"https":"http")+"://"+window._rblconf.issuer);var w=!1;a.getUserAgent=b,a.getPcId=c,a.getRcCode=d,a.getAdCode=e,a.getAbGroup=f,a.getSessionId=g,a.getRbst=h,a.getRefTerm=i,a.getRefPublisher=j,a.getAdId=k,a.getAdIdType=l,a.getPushId=m,a.getLooketAppsDevice=n,a.getCaulyId=o,a.getGsPcId=p,a.resetGuidState=q,a.setGuid=r,a.requestGuid=s,a.getGuid=t,a.addViewedItemInCookie=u,a.addViewedItem=v}(rblinfo||(rblinfo={}));var rblc;!function(a){function b(a,b,c){function d(){this.onload=this.onabort=this.onerror=function(){},f&&(clearTimeout(f),f=null),this.src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAAAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==","function"==typeof c&&c()}var e=new Image(1,1),f=null;e.onerror=e.onabort=d,e.onload=function(){f&&(clearTimeout(f),f=null),"function"==typeof b&&b()},e.src=J+(J.indexOf("?")<0?"?":"&")+a,f=setTimeout(function(a){return function(){d.call(a)}}(e),K)}function c(a,c){a&&b(a,c)}function d(a){var b,c,d,e,f={},g=!1,h=document.getElementsByTagName("meta");for(b=0;b<h.length;b++)c=h[b].getAttribute("property")||"",d=h[b].getAttribute("content")||"",0===c.indexOf("rb:")&&("rb:type"===c&&"product"===d?(f.type="product",g=!0):(e=c.replace("rb:",""),d&&(f[e]=String(rblutil.trim(d)))));return f.cuid=f.cuid||rblutil.getString(a.cuid,void 0),g&&f.cuid?f:null}function e(a){var b=rblutil.cloneObject(a);return b.type="visit",b.url=rblutil.getString(rblutil.purify(window.location.href),void 0),b.referrer=rblutil.getString(rblutil.getReferrer(),void 0),b.pcId&&b.url?b:null}function f(a){var b=rblutil.cloneObject(a);return b.type="view",b.itemId=rblutil.getString(a.itemId,""),b.itemId&&(rblinfo.addViewedItem(b.itemId),window._rblconf.useCookieStorage&&rblinfo.addViewedItemInCookie(b.itemId)),b}function g(a){var b=rblutil.cloneObject(a);return b.type="order",b.orderId=rblutil.getString(a.orderId,void 0),b.orderPrice=rblutil.getString(a.orderPrice,"").replace(/[^0-9.]/g,"")||void 0,b.orderItems=void 0,b.orderId?b:null}function h(a){var b=g(a);if(!b)return null;for(var c=a.orderItems||[],d=c.length,e=[],f=0;d>f;f++){var h=rblutil.cloneObject(b);h.itemId=rblutil.getString(c[f].itemId,void 0),h.price=rblutil.getString(c[f].price,"").replace(/[^0-9.]/g,"")||void 0,h.quantity=rblutil.getString(c[f].quantity,"").replace(/[^0-9.]/g,"")||void 0,h.optionId=rblutil.getString(c[f].optionId,void 0),h.itemId&&e.push(h)}return 0===e.length?null:e}function i(a,b){var c=b?rblutil.cloneObject(a):{};return c.cuid=rblutil.getString(a.cuid,""),c.domain=rblutil.getString(a.domain,""),c.domain||(c.domain=rblutil.getString(document.location.hostname,"")),c.apiVersion=rblutil.getString(a.apiVersion,void 0),c.device=rblutil.getString(a.device,"UNK"),"1"===c.device?c.device="PW":"2"===c.device&&(c.device="MW"),c.device=rblinfo.getLooketAppsDevice()||c.device,c.userId=rblutil.getString(a.userId,void 0),c.searchTerm=rblutil.getString(a.searchTerm,void 0)||rblinfo.getRbst()||void 0,c.locale=rblutil.getString(a.locale,void 0),c.abGroup=rblinfo.getAbGroup()||void 0,c.pcId=rblinfo.getPcId(),c.guid=rblinfo.getGuid()||void 0,c.rcCode=rblinfo.getRcCode()||void 0,c.adCode=rblinfo.getAdCode()||void 0,c.sessionId=rblinfo.getSessionId()||void 0,c.refPublisher=rblinfo.getRefPublisher()||void 0,c.refTerm=rblinfo.getRefTerm()||void 0,c.adId=rblinfo.getAdId()||void 0,c.adIdType=rblinfo.getAdIdType()||void 0,c.pushId=rblinfo.getPushId()||void 0,c.caulyId=rblinfo.getCaulyId()||void 0,a.hasOwnProperty("url")&&(c.url=rblutil.getString(a.url,void 0)||rblutil.getString(rblutil.purify(window.location.href),void 0)),a.hasOwnProperty("referrer")&&(c.referrer=rblutil.getString(a.referrer,void 0)||rblutil.getString(rblutil.getReferrer(),void 0)),c.gsPcId=rblinfo.getGsPcId()||void 0,c}function j(a){return i(a,!1)}function k(a){return i(a,!0)}function l(a){var b="object"!=typeof JSON?rblutil.JSON.stringify(a):JSON.stringify(a),c="data="+encodeURIComponent(b);return c}function m(a){var b=d(a);return b?(u(b,!0),!0):!1}function n(a){var b=f(a);return u(b,!0),!0}function o(b){var c=g(b),d=h(b);if(d){for(var e=0;e<d.length;e++)u(d[e],!1);return a.lastLog.order=d,!0}return c?(u(c,!0),!0):!1}function p(a,b){if(b){var c={};c.cuid=a.cuid,c.type="pcidcid",c.pcId=rblinfo.getPcId(),c.caulyId=b,u(c,!0),M=!0}}function q(a){var b=rblinfo.getCaulyId();if("undefined"!=typeof CaulyTracker)try{var c=new CaulyTracker;c.getCID(function(b){p(a,b)})}catch(d){p(a,b)}else p(a,b)}function r(a,b){var c={};c.cuid=a.cuid,c.type="pcidguid",c.pcId=rblinfo.getPcId(),c.guid=b,u(c,!0),rblinfo.setGuid(b),N=!0}function s(a){rblinfo.getGuid(function(b){b&&r(a,b)})}function t(a,b){if(b){var c=rblutil.cloneObject(a);return c.type=b,u(c,!0),!0}return!1}function u(b,d){var e=l(b);c(e),d&&(a.lastLog[b.type]=b)}function v(a){var b=rblutil.cloneObject(a);return b.type="search",b.searchResult=a.searchResult||[],b.searchTerm?(u(b,!0),!0):!1}function w(a){var b=rblutil.cloneObject(a);return b.type="user",b.userId?(u(b,!0),!0):!1}function x(a){var b=window._rblconf.forceTrackVisit||!1;if(!L||b){var c=e(a);if(c)return u(c,!0),L=!0,!0}return!1}function y(b){var c,d,e,f;for(c=0;c<arguments.length;c+=1)d=arguments[c],e=String(d.shift()),f=a[e],"function"==typeof f&&f.apply(a,d)}function z(){if(!(arguments.length<=0)){var b,c=[];for(b=1;b<arguments.length;b++)c.push(arguments[b]);var d=String(arguments[0]),e=a[d];"function"==typeof e&&e.apply(a,c)}}function A(b,c){a.data[b]=c}function B(b,c){a.data[b]=a.data[b]||[],c&&a.data[b].push(c)}function C(b){G();var c=j(a.data),d=k(a.data);if("product"===b)return m(c);if(!d.cuid||!d.domain||!d.pcId)return!1;var e=!1;return"view"===b?(e=n(d),q(d),setTimeout(function(){M||q(d)},5e3),s(d),setTimeout(function(){N||s(d)},5e3),x(c)):"order"===b?(e=o(d),x(c)):"search"===b?(e=v(d),x(c)):"user"===b?(e=w(d),x(c)):"visit"===b?e=x(c):""!==b&&(e=t(d,b)),e}function D(){try{var a=H();if(a.length>0)for(var b=0;b<a.length;b++)a[b]&&y(a[b])}catch(c){}}function E(){a.data={}}function F(){a.lastLog={}}function G(){"string"==typeof window._rblconf.receiver&&(J=("https:"===document.location.protocol?"https":"http")+"://"+window._rblconf.receiver)}function H(){for(var a=["_rblq","_rblqueue","_rlq2","_rlq"],b="",c=0;c<a.length;c++)if("undefined"!=typeof window[a[c]]){b=a[c];break}var d=[];b.length>0&&(d=window[b],window[b]=[]);var e=d.slice(0);return e}function I(){return"dev"===a.env||"debug"===a.env?{getProduct:d,getVisit:e,getView:f,getOrder:g,getOrderItems:h,getBase:k,getCommon:j,refineBase:i,getRequestQuery:l}:{}}a.version="2.1.0",a.name="RecoBell Logger Client",a.data={},a.lastLog={},a.env="prod";var J=("https:"===document.location.protocol?"https":"http")+"://rblogger-receiver-apne1.recobell.io/rest/logs",K=1e4,L=!1,M=!1,N=!1;a.apply=y,a.operate=z,a.setValue=A,a.addValue=B,a.track=C,a.flush=D,a.clearData=E,a.clearLastLog=F,a.devFuncs=I,a.op=z,a.setVar=A,a.addVar=B,G(),rblinfo.getPcId(),rblinfo.getGuid(),rblutil.deleteCookieTop("RB_GCID")}(rblc||(rblc={})),rblc.env=window._rblenv||"prod",rblc.flush();